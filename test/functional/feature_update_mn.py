...
class MasternodesRpcBasicTest (DefiTestFramework):
    def set_test_params(self):
        ...
        self.extra_args = [['-txnotokens=0', '-amkheight=50', '-bayfrontheight=50', '-bayfrontgardensheight=50', '-dakotaheight=136', '-eunosheight=140', '-eunospayaheight=140', '-greatworldheight=145'],
                           ['-txnotokens=0', '-amkheight=50', '-bayfrontheight=50', '-bayfrontgardensheight=50', '-dakotaheight=136', '-eunosheight=140', '-eunospayaheight=140', '-greatworldheight=145'],
                           ['-txnotokens=0', '-amkheight=50', '-bayfrontheight=50', '-bayfrontgardensheight=50', '-dakotaheight=136', '-eunosheight=140', '-eunospayaheight=140', '-greatworldheight=145']]
    ...
    def run_test(self):
        ...
        # UPDATING
        #========================
        assert_raises_rpc_error(-32600, "called before GreatWorld height", self.nodes[0].updatemasternode, idnode0, collateral0)

        self.nodes[0].generate(50)

        assert_raises_rpc_error(-32600, "Masternode with that operator address already exists", self.nodes[0].updatemasternode, idnode0, collateral0)
