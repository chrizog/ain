...
class TestForcedRewardAddress(DefiTestFramework):
    def set_test_params(self):
        ...
        self.extra_args = [
            ['-txindex=1', '-txnotokens=0', '-amkheight=50', '-bayfrontheight=50', '-greatworldheight=1'],
            ['-txindex=1', '-txnotokens=0', '-amkheight=50', '-bayfrontheight=50', '-greatworldheight=1'],
        ]
    ...
    def run_test(self):
        ...
        self.stop_node(1)
        self.restart_node(0, ['-gen', '-masternode_operator='+mn_owner, '-txindex=1', '-txnotokens=0', '-amkheight=50', '-bayfrontheight=50', '-greatworldheight=1'])
        ...
        self.restart_node(0, ['-gen', '-masternode_operator='+mn_owner, '-rewardaddress='+cli_reward_address, '-txindex=1', '-txnotokens=0', '-amkheight=50', '-bayfrontheight=50', '-greatworldheight=1'])
